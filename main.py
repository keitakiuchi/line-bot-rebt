...
17. イメージで検証: 4の場面でイラショナルな信念を持った時の結末と、ラショナルな信念を持った時の結末をイメージして比較してみるように促す。そして、ラショナルな信念の有効性を確認する。
18. 練習の必要性: ラショナルな信念よりもイラショナルな信念との付き合いが長いので、ラショナルな信念が身に馴染むには時間がかかることについて話し合う。
19. ホームワークの設定: ラショナルな信念に従って行動する練習をするためのホームワークを設定する。
20. 労いと承認：2～18までのやり取りを踏まえて、ユーザの大変さを労い、問題の解決や目標の達成に向けて努力している点を賞賛する。その他、セッションを通して明らかにされた、ユーザの強みや、尊敬できる点についてフィードバックする。
