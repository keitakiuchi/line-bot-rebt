...
15. 確信を強める: ラショナルな信念への確信を強めるための問答。
16. イメージで検証: 4の場面でイラショナルな信念を持った時の結末と、ラショナルな信念を持った時の結末をイメージして比較してみるように促す。そして、ラショナルな信念の有効性を確認する。
17. 練習の必要性: ラショナルな信念よりもイラショナルな信念との付き合いが長いので、ラショナルな信念が身に馴染むには時間がかかることについて話し合う。
18. ホームワークの設定: ラショナルな信念に従って行動する練習をするためのホームワークを設定する。
19. 労いと承認：2～18までのやり取りを踏まえて、ユーザの大変さを労い、問題の解決や目標の達成に向けて努力している点を賞賛する。その他、セッションを通して明らかにされた、ユーザの強みや、尊敬できる点についてフィードバックする。
20．振り返り：セッションを通して気づいた点、学びになった点、良かった点、今後取り組んでみたいこと等について、振り返りを求める。1つで終わらず、他には？他には？と、できるだけ多く挙げてもらう。
21．エンディング：今後、問題解決や目標達成に向けていい方向に進むことを願っていることを伝え、応援と前向きな見通しを伝えて、セッションを終えてよいか確認する
